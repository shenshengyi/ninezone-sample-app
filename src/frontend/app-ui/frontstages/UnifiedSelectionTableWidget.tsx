...
import { ContextMenuItem, ContextMenuItemProps, GlobalContextMenu } from "@bentley/ui-core";
import {
...
class UnifiedSelectionTableWidget extends React.PureComponent<
  UnifiedSelectionTableWidgetProps,
  UnifiedSelectionTableWidgetState
> {
  ...
  public static getDerivedStateFromProps(
    props: UnifiedSelectionTableWidgetProps,
    state: UnifiedSelectionTableWidgetState
  ): UnifiedSelectionTableWidgetState | null {
    const needsDataProviderRecreated =
      props.iModelConnection !== state.dataProvider.imodel ||
      props.rulesetId !== state.dataProvider.rulesetId;
  ...
  public componentDidUpdate(
    _prevProps: UnifiedSelectionTableWidgetProps,
    prevState: UnifiedSelectionTableWidgetState
  ) {
  ...
  private buildContextMenu(args: TableCellContextMenuArgs) {
    ...
    items.push({
      ...
      title: IModelApp.i18n.translate(
        "SampleApp:table.context-menu.sample-item.description"
      ),
      label: IModelApp.i18n.translate(
        "SampleApp:table.context-menu.sample-item.label"
      ),
    });
...
const createDataProviderFromProps = (props: UnifiedSelectionTableWidgetProps) =>
  new PresentationTableDataProvider({
    imodel: props.iModelConnection!,
    ruleset: props.rulesetId!,
  });

ConfigurableUiManager.registerControl(
  "UnifiedSelectionTableDemoWidget",
  UnifiedSelectionTableWidgetControl
);
