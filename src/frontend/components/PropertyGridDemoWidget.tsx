  ...
  constructor(info: ConfigurableCreateInfo, options: any) {
    ...
    this.reactNode = (
      <WidgetContent
        ...
        content={<HorizontalPropertyGridWidget style={{ overflow: "unset" }} />}
        ref={this._ref}
      />
    );
  }
...
export class HorizontalPropertyGridWidgetControl2 extends WidgetControl {
  constructor(info: ConfigurableCreateInfo, options: any) {
    ...
    this.reactNode = (
      <HorizontalPropertyGridWidget style={{ overflow: "auto" }} />
    );
  }
}

export class HorizontalPropertyGridWidget extends React.Component<{
...
ConfigurableUiManager.registerControl(
  "HorizontalPropertyGridDemoWidget",
  HorizontalPropertyGridWidgetControl
);
...
ConfigurableUiManager.registerControl(
  "HorizontalPropertyGridDemoContent",
  HorizontalPropertyGridContentControl
);
