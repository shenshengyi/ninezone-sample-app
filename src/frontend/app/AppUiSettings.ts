...
import { NineZoneSampleApp, SampleAppUiActionId } from "./NineZoneSampleApp";
...
export class AppUiSettings {
  ...
  constructor() {
    ...
    this.colorTheme = new UiSetting<string>(
      AppUiSettings._settingNamespace,
      "ColorTheme",
      UiFramework.getColorTheme,
      UiFramework.setColorTheme
    );
    this._settings.push(this.colorTheme);

    this.autoHideUi = new UiSetting<boolean>(
      AppUiSettings._settingNamespace,
      "AutoHideUi",
      () => UiShowHideManager.autoHideUi,
      (value: boolean) => (UiShowHideManager.autoHideUi = value)
    );
    this._settings.push(this.autoHideUi);

    this.useProximityOpacity = new UiSetting<boolean>(
      AppUiSettings._settingNamespace,
      "UseProximityOpacity",
      () => UiShowHideManager.useProximityOpacity,
      (value: boolean) => (UiShowHideManager.useProximityOpacity = value)
    );
    this._settings.push(this.useProximityOpacity);

    this.snapWidgetOpacity = new UiSetting<boolean>(
      AppUiSettings._settingNamespace,
      "SnapWidgetOpacity",
      () => UiShowHideManager.snapWidgetOpacity,
      (value: boolean) => (UiShowHideManager.snapWidgetOpacity = value)
    );
    this._settings.push(this.snapWidgetOpacity);

    this.dragInteraction = new UiSetting<boolean>(
      AppUiSettings._settingNamespace,
      "DragInteraction",
      () => NineZoneSampleApp.store.getState().sampleAppState.dragInteraction,
      (value: boolean) =>
        UiFramework.dispatchActionToStore(
          SampleAppUiActionId.setDragInteraction,
          value,
          true
        )
    );
    ...
    this.frameworkVersion = new UiSetting<string>(
      AppUiSettings._settingNamespace,
      "FrameworkVersion",
      () => NineZoneSampleApp.store.getState().sampleAppState.frameworkVersion,
      (value: string) =>
        UiFramework.dispatchActionToStore(
    ...
    // this.escapeToHome = new UiSetting<boolean>(
    //   AppUiSettings._settingNamespace,
    //   "EscapeToHome",
    //   () => UiFramework.escapeToHome,
    //   (value: boolean) => (UiFramework.escapeToHome = value)
    // );
    // this._settings.push(this.escapeToHome);

    // this.accuDrawNotifications = new UiSetting<boolean>(
    //   AppUiSettings._settingNamespace,
    //   "AccuDrawNotifications",
    //   () => FrameworkAccuDraw.displayNotifications,
    //   (value: boolean) => (FrameworkAccuDraw.displayNotifications = value)
    // );
    // this._settings.push(this.accuDrawNotifications);

    this.widgetOpacity = new UiSetting<number>(
      AppUiSettings._settingNamespace,
      "WidgetOpacity",
